...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.setMinimumSize(QtCore.QSize(660, 630))
        Form.setMaximumSize(QtCore.QSize(660, 630))
        self.verticalLayoutWidget = QtWidgets.QWidget(Form)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(5, 5, 640, 501))
        ...
        self.LoadParamsButton = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.LoadParamsButton.setObjectName("LoadParamsButton")
        self.paramHorizontalLayout.addWidget(self.LoadParamsButton)
        self.SaveParamsButton = QtWidgets.QPushButton(self.verticalLayoutWidget)
        ...
        self.SelectAllcheckBox.setMaximumSize(QtCore.QSize(32, 32))
        ...
        spacerItem0 = QtWidgets.QSpacerItem(200, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.MenuhorizontalLayout.addItem(spacerItem0)
        ...
        self.DisconnectAllButton = QtWidgets.QPushButton(self.verticalLayoutWidget)
        ...
        self.listOfRobots = QtWidgets.QListWidget(self.verticalLayoutWidget)
        self.listOfRobots.setObjectName("listOfDrones")
        self.listOfRobots.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)

        self.verticalLayout.addWidget(self.listOfRobots)
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(10, 520, 311, 101))
    ...
    def retranslateUi(self, Form):
        ...
        self.SelectAllcheckBox.setText(_translate("Form", ""))
        self.ConnectAllButton.setText(_translate("Form", "connect"))
        self.DisconnectAllButton.setText(_translate("Form", "Disconnect"))
        self.ArmAllButton.setText(_translate("Form", "Motors ON"))
        self.DisarmAllButton.setText(_translate("Form", "Motors OFF"))
